...
zip -r rename_me log/
rm -r log
ruby  -v  ~/documents/thennessy/archive/ruby\ source\ materials/Prepare_archive_logs_for_processing/lib/main.rb *.log 1>prepare_archive_logs_stdout.lst 2>prepare_archive_logs_stderr.lst

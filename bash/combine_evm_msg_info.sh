...
rm combined_evm_msg_info.csv
ruby -v ../ruby/Test_csv_file_manipulation/main.rb *.log 1>csv_manipulate_stdout.lst 2>csv_manipulate_stderr.lst
sort sorted_evm_msg_info.csv > sorted__evm_msg_info.csv
ruby -v ../ruby/Test_csv_file_merge/lib/main.rb *.log 1>csv_merge_stdout.lst 2>csv_merge_stderr.lst
exit

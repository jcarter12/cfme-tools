...
def extract_selected_files(bundle,new_directory,selected_files)
    ...
    cmd_line = '"C:\\Program Files\\7-Zip\\7z.exe" e ' + bundle + " -o.\\#{new_directory} #{selected_files}"
#    cmd_line = '7z e ' + bundle + " -o.\\#{new_directory} #{selected_files}"  
...
#  puts "#{_vector.inspect}"
  _return = `"C:\\Program Files\\7-Zip\\7z.exe" l #{bundle}`.split("\n")
